                    ...
                    <ModalContainer>
                        ...
                        >
                            <AutoColumn gap="sm" style={{margin:"10px"}}>
                                <RowBetween>
                                    <div></div>
                                    <div onClick={()=>{connectActive && setConnectActive(false)}}>
                                        <img src={close} style={{height:"10px", width:"10px"}}/>
                                    </div>
                                </RowBetween>
                                <Row style={{justifyContent:"center"}}>
                                    <div onClick={()=>{activate(injectedConnector); connectActive && setConnectActive(false)}}>
                                        <img src={metamaskImg} style={{height:"30px", width:"30px"}}/>
                                    </div>
                                    <div onClick={()=>{activate(torusConnector); connectActive && setConnectActive(false)}}>
